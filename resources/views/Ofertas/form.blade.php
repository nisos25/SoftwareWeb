...
<input type="text" class="form-control" name="Descuento" value="{{isset($producto->descuento)?$producto->descuento:old('Descuento')}}" id="descuento">
</div>
<div class="form-grup">
...
<a class="btn btn-primary" href="{{url('Ofertas')}}"> RESGRESAR</a>
