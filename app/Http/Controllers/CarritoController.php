...
class CarritoController extends Controller
{
    ...
    public function index()
    {
        ...
        $total['total']=productocanasta::select('id_usuario','productocanastas.precio','productocanastas.descuento','carritos.cantidad')->from('productocanastas')->join('carritos',function($query){
            $query->on('productocanastas.id','=','carritos.idprod');
        })->get();
